        ...
        {sortedNotes.map((note) => (
          <div key={note.id} className="card hover:shadow-lg transition-shadow">
            ...
            <div className="flex gap-2">
              <Link
                to={`${note.id}`}
                className="btn text-white flex gap-2  justify-center bg-green-600  hover:bg-green-700 flex-1 text-center"
              >
                <IconEye />
                Ver
              </Link>
              ...
              <button
                ...
                className="btn btn-danger flex gap-2  justify-center flex-1"
              >
                <IconTrash />
                Eliminar
              </button>
